...
<div class="page-wrapper">
  ...
  <header class="main-header">
    <div class="main-header__container container">
      ...
      <a class="main-header__logo" href="{{route('index')}}">
      ...
      <a class="main-header__add-lot button" href="{{route('add-lot')}}">Добавить лот</a>
      <nav class="user-menu">
        <? if ($is_auth == 1) { ?>
        ...
        <? }
            ...
            <ul class="user-menu__list">
                <li class="user-menu__item">
                    <a href="{{route('sign-up')}}">Регистрация</a>
                </li>
                <li class="user-menu__item">
...
<footer class="main-footer">
  ...
  <div class="main-footer__bottom container">
    ...
    <a class="main-footer__add-lot button" href="{{route('add-lot')}}">Добавить лот</a>
